...
exhausting the RAM and causing extreme slowness. 
...
The user resolved the issue by replacing the above line with {\tt max\_allowed\_packet=20M}. 
...
In the above, 104857600 represents the integer value of 100 megabytes.  
