...
error that a value is set too high or too low.
...
One possible way to reach this conclusion more quickly is to determine that the original value for 
{\tt max\_allowed\_packet}, 100 MB, was statistically deviant and extremely large. 
...
prudent to set the value lower. 
