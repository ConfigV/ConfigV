...
The learning process is a more expressive form of association rule learning~\cite{agrawal1993mining}, which is used to learn predicate relations between multiple keywords in a configuration file.
The rules, in general, specify which properties such as, one kewyord must appear before another, or the value of one keyword should always be greater than another.
...
\ruzica{hmmm... this appears to be repeating - can you merge some of those stuff with stuff above}
