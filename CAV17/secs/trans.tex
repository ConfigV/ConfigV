...
Taking the configuration \ref{lst:1.cnf} \ennan{configuration 1.4 is too
far away from this place}, we can assume {\tt foo} is a boolean type by the grammar of MySQL,
