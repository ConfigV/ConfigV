...
To our knowledge, there have been several prior efforts that attempt to verify 
...
framework, \app, that can learn a language model from a training set
of configuration files, and then use this language model to verify 
