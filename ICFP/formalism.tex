...
\begin{flalign*}
\mathcal{LP}& =\ \{ r\ \mid \\
  & \Pi file \in \mathcal{CP},\ r(file)\  \land\\
  & \exists file \in \mathcal{CP},\ r(file) \text{ is non-trivial} \} \\
\mathcal{RP}& =\ \{ r\ \mid \\
  & r \in \mathcal{LP}\ \land\\
  & \neg r(userfile) \}&\\
\end{flalign*}
...
\begin{flalign}
& \forall r \in \mathcal{T}, r \in \mathcal{RP} \qquad \text{[Incomplete]} \\
& \exists r \in \mathcal{RP}, r \notin \mathcal{T} \qquad \text{[Unsound]}
\end{flalign}
