...
This extension will buid a logical formula representing the entire history of examples, and use a SMT solver to find a classification model.
...
Since we now consider both incorrect and correct data, we will denote the build status of $P_t$ with $S(P_t)$.
