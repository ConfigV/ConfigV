...
The breaking rules will describe the conditions for an incorrect file based on examples we have seen of incorrect files.
Likewise, the necessary rules will describe the conditions for a correct file based on examples we have seen of correct files.
As shown in Figure~\ref{fig:versionSL}, this can result in a space where a file may contain relations that cannot be classified as either breaking or necessary.
