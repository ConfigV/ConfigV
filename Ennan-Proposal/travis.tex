...
\begin{figure}[!tbh]
  ...
  \begin{tikzpicture}
    ...
    \node [align=left] at (1.5,3.5) {Breaking Rules: \\ \footnotesize ``node\_js $\le$ 0''};
    \draw (4,1) rectangle (8,3);
    \node [align=left] at (5.6,2.2) {Necessary Rules: \\ \footnotesize ``language:node\_js \\ \footnotesize $\ \land$ node\_js:version''};
  \end{tikzpicture}
  \caption{An example set of necessary and breaking rules.}
  \label{fig:versionSL}
\end{figure}
