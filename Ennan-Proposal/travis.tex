...
\begin{figure}[!tbh]
  \centering
  \begin{tikzpicture}
    \draw (0,0) rectangle (6,3.7); 
    \node [align=left] at (1.5,2.9) {\footnotesize \textbf{Breaking Rules}: \\ \footnotesize node\_js $\le$ 0 \\ \footnotesize \ldots};
    \draw (1.6,0.2) rectangle (5,2.2);
    \node [align=left] at (3.3,1.3) {\footnotesize \textbf{Necessary Rules}: \\ \footnotesize node\_js $\ge$ 0.4 \\ \footnotesize \ldots};
  \end{tikzpicture}
