...
One such example of such a training set of configuration files is TravisCI~\cite{travis}.
...
classification~\cite{mitchell82}, which we use to test a configuration file for membership
