...
these tools rely on manual ways to understand and detect the failure symptoms. The main reason for this approach ... \ruzica{Ennan, can you talk here how usually config files look, only untyped assigments}
