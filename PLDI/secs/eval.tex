...
We are guaranteed these are all false positives since there cannot be a rule of type $size*size=size$ because of the semantic interpretation of the $size$ units.
